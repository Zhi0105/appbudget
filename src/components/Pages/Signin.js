...
export const Signin = ({ navigation }) => {
  ...
  return (
    <View className="signin-main min-h-screen flex justify-center items-center">
      <View className="body min-h-[90%] bg-white w-full flex justify-center items-center">
          ...
          />
          <Text className="mt-4 text-3xl font-bold">Welcome!</Text>
          <View className="w-3/4 py-4 space-y-4 form md:space-y-6">
            ...
            <Text className="text-center font-bold text-lg text-[#2f3d8a]">
              Forgot Password ?
            </Text>
      ...
      <View className="footer min-h-[10%] w-full bg-[#D9D9D9] flex justify-center items-center p-5">
        <Text className="text-lg font-bold">Don't have an account? <Text onPress={() => navigation.navigate('Signup')} className="text-[#2f3d8a] font-extrabold">SIGN UP</Text></Text>
      </View>
    </View>
  )
}
